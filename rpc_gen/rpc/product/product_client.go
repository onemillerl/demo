...
type RPCClient interface {
	...
	GetProductcenter(ctx context.Context, Req *product.GetProductcenterReq, callOptions ...callopt.Option) (r *product.GetProductcenterResp, err error)
	Searchproductcenters(ctx context.Context, Req *product.SearchproductcentersReq, callOptions ...callopt.Option) (r *product.SearchproductcentersResp, err error)
}
...
func (c *clientImpl) GetProductcenter(ctx context.Context, Req *product.GetProductcenterReq, callOptions ...callopt.Option) (r *product.GetProductcenterResp, err error) {
	return c.kitexClient.GetProductcenter(ctx, Req, callOptions...)
}

func (c *clientImpl) Searchproductcenters(ctx context.Context, Req *product.SearchproductcentersReq, callOptions ...callopt.Option) (r *product.SearchproductcentersResp, err error) {
	return c.kitexClient.Searchproductcenters(ctx, Req, callOptions...)
}
