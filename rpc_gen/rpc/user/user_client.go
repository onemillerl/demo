...
func (c *clientImpl) DeleteProductId(ctx context.Context, Req *user.DeleteProductIdReq, callOptions ...callopt.Option) (r *user.DeleteProductIdResp, err error) {
	return c.kitexClient.DeleteProductId(ctx, Req, callOptions...)
}
