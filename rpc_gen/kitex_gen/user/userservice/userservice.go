...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"DeleteProductId": kitex.NewMethodInfo(
		deleteProductIdHandler,
		newDeleteProductIdArgs,
		newDeleteProductIdResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
}
...
func deleteProductIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(user.DeleteProductIdReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(user.UserService).DeleteProductId(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteProductIdArgs:
		success, err := handler.(user.UserService).DeleteProductId(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DeleteProductIdResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDeleteProductIdArgs() interface{} {
	return &DeleteProductIdArgs{}
}

func newDeleteProductIdResult() interface{} {
	return &DeleteProductIdResult{}
}

type DeleteProductIdArgs struct {
	Req *user.DeleteProductIdReq
}

func (p *DeleteProductIdArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(user.DeleteProductIdReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *DeleteProductIdArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *DeleteProductIdArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *DeleteProductIdArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DeleteProductIdArgs) Unmarshal(in []byte) error {
	msg := new(user.DeleteProductIdReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DeleteProductIdArgs_Req_DEFAULT *user.DeleteProductIdReq

func (p *DeleteProductIdArgs) GetReq() *user.DeleteProductIdReq {
	if !p.IsSetReq() {
		return DeleteProductIdArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DeleteProductIdArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DeleteProductIdArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DeleteProductIdResult struct {
	Success *user.DeleteProductIdResp
}

var DeleteProductIdResult_Success_DEFAULT *user.DeleteProductIdResp

func (p *DeleteProductIdResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.DeleteProductIdResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *DeleteProductIdResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *DeleteProductIdResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *DeleteProductIdResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DeleteProductIdResult) Unmarshal(in []byte) error {
	msg := new(user.DeleteProductIdResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DeleteProductIdResult) GetSuccess() *user.DeleteProductIdResp {
	if !p.IsSetSuccess() {
		return DeleteProductIdResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DeleteProductIdResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.DeleteProductIdResp)
}

func (p *DeleteProductIdResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DeleteProductIdResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) DeleteProductId(ctx context.Context, Req *user.DeleteProductIdReq) (r *user.DeleteProductIdResp, err error) {
	var _args DeleteProductIdArgs
	_args.Req = Req
	var _result DeleteProductIdResult
	if err = p.c.Call(ctx, "DeleteProductId", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
