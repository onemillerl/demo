...
func (p *kProductCatalogServiceClient) GetProductcenter(ctx context.Context, Req *product.GetProductcenterReq, callOptions ...callopt.Option) (r *product.GetProductcenterResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetProductcenter(ctx, Req)
}

func (p *kProductCatalogServiceClient) Searchproductcenters(ctx context.Context, Req *product.SearchproductcentersReq, callOptions ...callopt.Option) (r *product.SearchproductcentersResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Searchproductcenters(ctx, Req)
}
