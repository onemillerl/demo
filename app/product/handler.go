...
import (
	...
	"gomall_demo/app/product/biz/service"
)
...
// GetProductcenter implements the ProductCatalogServiceImpl interface.
func (s *ProductCatalogServiceImpl) GetProductcenter(ctx context.Context, req *product.GetProductcenterReq) (resp *product.GetProductcenterResp, err error) {
	resp, err = service.NewGetProductcenterService(ctx).Run(req)

	return resp, err
}

// Searchproductcenters implements the ProductCatalogServiceImpl interface.
func (s *ProductCatalogServiceImpl) Searchproductcenters(ctx context.Context, req *product.SearchproductcentersReq) (resp *product.SearchproductcentersResp, err error) {
	resp, err = service.NewSearchproductcentersService(ctx).Run(req)
